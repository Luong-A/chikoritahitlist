...
export const bountiesToPersons = sqliteTable(
  "bounties_to_persons",
  {
  ...
  (t) => [primaryKey({ columns: [t.bountyId, t.personId] })],
);
export const bountiesToPersonsRelations = relations(
  bountiesToPersons,
  ({ one }) => ({
    bounty: one(bounty, {
...
export const totpSettings = sqliteTable("totp_settings", {
